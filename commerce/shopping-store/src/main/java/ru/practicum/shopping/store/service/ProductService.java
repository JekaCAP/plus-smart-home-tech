...
public interface ProductService {
    ...
    ProductDto createNewProduct(@Valid @RequestBody ProductDto newProductDto);

    ProductDto updateProduct(@Valid @RequestBody ProductDto updateProductDto);

    boolean removeProductFromStore(@RequestBody UUID productId);

    boolean setProductQuantityState(@Valid UUID productId, QuantityState quantityState);
