...
@Component
public class ScenarioRemovedGrpcHandler extends AbstractHubEventHandler {


    public ScenarioRemovedGrpcHandler(ProtobufToAvroMapper mapper, KafkaEventProducer producer) {
