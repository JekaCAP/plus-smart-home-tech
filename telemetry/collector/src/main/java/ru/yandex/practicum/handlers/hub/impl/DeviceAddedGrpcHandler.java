...
@Component
public class DeviceAddedGrpcHandler extends AbstractHubEventHandler {

    public DeviceAddedGrpcHandler(ProtobufToAvroMapper mapper, KafkaEventProducer producer) {
