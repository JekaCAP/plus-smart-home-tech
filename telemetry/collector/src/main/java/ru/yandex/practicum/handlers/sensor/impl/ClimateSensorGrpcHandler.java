...
@Component
public class ClimateSensorGrpcHandler extends AbstractSensorEventHandler {

    public ClimateSensorGrpcHandler(ProtobufToAvroMapper mapper, KafkaEventProducer producer) {
