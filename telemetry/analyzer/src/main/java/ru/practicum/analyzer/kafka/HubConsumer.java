...
/**
 * Kafka consumer для обработки событий хаба (HubEventAvro).
 * <p>
 * Слушает топики хаба, обрабатывает добавление/удаление сенсоров
 * и добавление/удаление сценариев.
 * <p>
 * Для добавления сенсора использует {@link AvroToEntityMapper} и сохраняет
 * через {@link SensorRepository}. Для сценариев делегирует обработку
